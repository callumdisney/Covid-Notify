# !/usr/bin/env python3
# Desktop notifier built for updates for the covid pandemic in the USA
# Made by traditionallimb - Refined and parts added by Callum Disney
# Made 10.11.20
# Refined and parts added 04.01.2
...
if (covidData != None):
    ...
    while(True):
        notification.notify(
            ...
            title = "USA COVID-19 Stats today ({})".format(datetime.date.today()),
