# !/usr/bin/env python3
# Desktop notifier built for updates for the covid pandemic in France
...
covidData = None
try:
  covidData = requests.get("https://corona-rest-api.herokuapp.com/Api/France/")
except:
...
if (covidData != None):
    ...
    while(True):
        notification.notify(
            ...
            title = "France COVID-19 Stats today ({})".format(datetime.date.today()),
