# !/usr/bin/env python3
# Desktop notifier built for updates for the covid pandemic in Turkey
...
covidData = None
try:
  covidData = requests.get("https://corona-rest-api.herokuapp.com/Api/Turkey/")
except:
...
if (covidData != None):
    ...
    while(True):
        notification.notify(
            ...
            title = "Turkey COVID-19 Stats today ({})".format(datetime.date.today()),
